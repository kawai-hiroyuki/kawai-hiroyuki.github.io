...
function quizViewLoaded() {
  ...
  $("#quiz_question").text(currentQuizNum + " " + questions[seq[q_now]][0]);
  for (i = 0; i < a_seq.length; i++) {
    j = a_seq[i] + 1;
    var k = i + 1;
    $("#quiz_answer").append("<div id='qan" + j + "' class='qan_list' onclick='q_answer(" + j + ");'>第"　+ k + "問 " + questions[seq[q_now]][1][a_seq[i]] + "</div>");
  }
